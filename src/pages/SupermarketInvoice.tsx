...
import { useInventory, Ingredient, categorizeIngredient } from '../context/InventoryContext';
...
function SupermarketInvoice({ onNavigateHome }: SupermarketInvoiceProps) {
  const { ingredients, addIngredients } = useInventory();
